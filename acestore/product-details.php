...
<body>
					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p>Web ID: <?php echo htmlspecialchars($product_id); ?></p>
								<img src="images/product-details/rating.png" alt="" />
								<span>
									<span>US $<?php echo number_format($row['price'], 2); ?></span>
								...
								<p><b>Brand:</b> <?php echo htmlspecialchars($row['brand']); ?></p>
	...
	<div class="footer-widget">
		...
		<div class="footer-bottom" >
			<div class="container">
				<div class="row">
					<p class="text-center">Copyright © 2023 Ace Store. All rights reserved.</p>
